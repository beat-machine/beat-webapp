export let effectDefinitions = [
    ...
    },
    {
        ...
        validate(paramObj) {
            ...
            if (paramObj['x_period'] > paramObj['group_size'] || paramObj['y_period'] > paramObj['group_size']) {
    ...
    },
    {
        ...
        validate(paramObj) {
            if (paramObj['take_index'] > paramObj['denominator']) {
                return `Can't take piece #` + paramObj['take_index'] + ` of a beat that's only being divided into ` + paramObj['denominator'] + ` parts.`
            }

            return null;
        },
        serialize: (paramObj) => { return { ...paramObj, take_index: paramObj['take_index'] - 1 } }
    },
    {
        "id": "repeat",
        "name": "Repeat",
    ...
    },
    {
        "id": "randomize",
        "name": "Randomize",
        "description": "Totally randomizes all beats. It's terrible. You don't want this.",
        "params": [],
        validate: () => null,
        serialize: (paramObj) => paramObj
    }
